...
const MyProfile = () => {
 ...
 // whenever you want to add
  ...
  //we get the whole user data, and then down on the page we can use it
  //we get it from our context 'value' in the appcontext
  //along with the div and all that
    ...
    <div className=' max-w-lg flex flex-col gap-2 text-sm '>
      ...
      ? <label htmlFor="image">
        <div className='inline-block relative cursor-pointer '>
          <img className='w-36 rounder opacity-75' src={image ? URL.createObjectURL(image): userData.image}   alt="" />
          <img className='w-10 aboslute bottom-12 right-12' src={image ? '': assets.upload_icon } alt="" />
        </div>
